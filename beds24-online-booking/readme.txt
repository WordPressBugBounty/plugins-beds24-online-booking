...
Accept commission free online bookings from your Wordpress website. Suitable for hotels, B&B's, holiday rentals, vacation rentals, apartments, villas and hostels. 
== Description ==
...
5. In Wordpress go click on "Settings" in the left menu then on "Beds24".
6. Enter your Beds24 ID 
7. Choose from our selection of widgets and paste the shortcode into a post, page or sidebar.
...
== Changelog ==
= 2.0.30 =
* fixed missing shortcode attribute escape
...
= 2.0.25 =
* fixed unescaped hrefs

= 2.0.24 =
* fixed unescaped settings

= 2.0.23 =
* added noExternalFonts parameter for widget shortcode plus bug fix
